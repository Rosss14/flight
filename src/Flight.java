...
public class Flight {
    ...
    public boolean equals1(Flight otherFlight) {
        if (flightCode.equalsIgnoreCase(otherFlight.getCode())
                && airportOrigin.equalsIgnoreCase(otherFlight.getOrigin())
                && airportDestination.equalsIgnoreCase(otherFlight.getDestination())) return true;
        else return false;
    }
